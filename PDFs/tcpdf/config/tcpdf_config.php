 ...
 */
//define ('PDF_HEADER_LOGO', '../ud07ejer01/jo01.jpg');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'JCRM');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Juan Carlos Ramos Moll');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'EJERCICIO PDF');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Carles Ramos - 2ºDaw Semi");
